...
class BrokenMutex // Wrapper around pthread_mutex, but without implementation
{
public:
    BrokenMutex() { } // Constructor
    ~BrokenMutex() { } // Destructor
...
private:
    ...
    BrokenMutex actions_access; // Synchronization of access to the queue as it can be accessed by both the library and the readers
