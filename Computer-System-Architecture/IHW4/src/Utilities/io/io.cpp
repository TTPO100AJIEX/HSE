...
io::RandomInput::RandomInput() // Constructor: generated the data
{
    ...
    std::uniform_int_distribution<std::mt19937::result_type> random_10(1, 10), random_100(1, 100), random_600(1, 600), random_1e4(1, 1e4), random_1e5(1, 1e5), random_1e9(1, 1e9); // Uniform distributions to generate the numbers for the input
    ...
    size_t amount_of_readers = random_1e4(gen); this->data.push_back(amount_of_readers); // Generate the amount of readers
