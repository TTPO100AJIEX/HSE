...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(cvtda.topology.DiagramVectorizer.PRESETS.reduced, 56, id = 'reduced'),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(25, id = 'many_objects')
    ]
)
@pytest.mark.parametrize(
    ['batch_size'],
    [
        pytest.param(None, id = 'default_batch_size'),
        pytest.param(1, id = 'batch_one'),
        pytest.param(10, id = 'batch_ten')
    ]
)
