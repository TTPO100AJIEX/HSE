...
def make_filtration_extractor(vectorizer_settings: DiagramVectorizer.Settings, return_diagrams: bool):
    return FiltrationExtractor(
        gtda.images.HeightFiltration, { 'direction': numpy.array([ 1, 1 ]) }, 0.4, vectorizer_settings,
        return_diagrams = return_diagrams, n_jobs = 1
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(DiagramVectorizer.PRESETS.reduced, 56 * 2, id = 'reduced'),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(DiagramVectorizer.PRESETS.reduced, 56 * 2 * 4, id = 'reduced'),
