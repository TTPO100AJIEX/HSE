# The script originates from https://github.com/TTPO100AJIEX/CVTDA/tree/main/reproduction
# Some datasets used in the script will not be downloaded automatically.
# You should place them manually in the current working directory beforehand.
# The exact data with reproducible train/test splitting is available at the above URL.
...
if args.quick:
    # For the quick script, we take a subset of each dataset
    FRACTION = {
        "mnist": 0.2,
        "fmnist": 0.2,
        "cifar-10": 0.25,
...
if args.quick:
    # Initialize the preset and reduce the number of training epochs for the quick script.
...
def process_impl(
    ...
    if args.quick:
        # For the quick script, get a subset and transform all images to grayscale.
    ...
    # Read persistence diagrams from the dump
...
def segmentation(name):
    ...
    def transforms_wrapper(image, mask):
        # For segmentation, we need to transform both images and masks synchronously
...
with cvtda.logging.DevNullLogger():
    ...
    # A ready-to-use version is available at https://github.com/TTPO100AJIEX/CVTDA/tree/main/reproduction/faces
    ...
    # A ready-to-use version is available at https://github.com/TTPO100AJIEX/CVTDA/tree/main/reproduction/lfw
    transform = torchvision.transforms.v2.Compose(
        [
    ...
    # A ready-to-use version is available at https://github.com/TTPO100AJIEX/CVTDA/tree/main/reproduction/midv500p
